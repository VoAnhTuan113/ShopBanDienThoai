<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBanDienThoai.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="ShopBanDienThoai.HomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align:center">
        <h1 style="font-family:Dosis"><b>CHÀO MỪNG BẠN ĐẾN VỚI NPT SHOP</b></h1>
    </div>
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="5" CellSpacing="5">
        <ItemTemplate>
            <div class="card">
